...
import offerDeclined from "../assets/images/declinedOffer.svg";
...
const ImageCatalog = styled("div")(
  mq({
    ...
    right: 20,
    backgroundImage: `url(${offerDeclined})`,
      ...
      <RowMobile>
        <Col span={24}>
          ...
          <Text
            ...
            marginBottom={2}
          >
            <FormattedMessage id="OFFER_DECLINED_TITLE_1" />
          </Text>
          <Text
            fontSize={32}
            lineHeight="40px"
            ...
            marginBottom={12}
          >
            <FormattedMessage id="OFFER_DECLINED_TITLE_2" />
          </Text>
          <Text
            fontSize={16}
            lineHeight="24px"
            ...
            color="#4F4F4F"
          >
            <FormattedMessage id="OFFER_DECLINED_TEXT" />
          </Text>
          <Text
            fontSize={16}
            lineHeight="24px"
          ...
          >
            <FormattedMessage
              id="OFFER_ECLINED_TEXT_WITH_EMAIL"
              values={{
                email: (
                  <a href="mailto: GameStopTradeIn@PCSWW.com">
                    <Span link={true}>GameStopTradeIn@PCSWW.com</Span>
                  </a>
                ),
              }}
            />
